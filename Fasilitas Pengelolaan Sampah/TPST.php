      ...
      <div class="container px-5">
        <div class="row gx-5 justify-content-center">
          <div class="col-xxl-12 col-12">
            <h4 class="text-center">Data Tempat Pengolahan Sampah Terpadu (TPST) Diluar TPA</h4>
              ...
              <div class="card-body">
                <table id="example" class="table table-striped" style="width:100%">
                  ...
                  <tbody>
                    ...
                    $tipe_fasilitas = "TPST di luar TPA"; // Ganti dengan tipe fasilitas yang diinginkan
