...
<head>
  ...
  <title>Recycle Power - Dashboard Admin</title>
...
<body>
          ...
          <div class="col-12 col-lg-9">
            ...
            <div class="row">
              <div class="col-12 col-xl-4">
                <div class="card">
                  <div class="card-header">
                    <h4>SCOREBOARD - Jumlah Orang yang di Edukasi</h4>
                  </div>
                  <div class="card-body">
                    <?php
                    // Tampilkan username dan nilai SUM kolom sampah_organik sesuai username
                    $query = "SELECT username, SUM(edukasi) AS total FROM input GROUP BY username ORDER BY total DESC";
              ...
              <div class="col-12 col-xl-4">
                <div class="card">
                  <div class="card-header">
                    <h4 class="mb-3">SCOREBOARD - Jumlah Rumah yang telah memilah Sampah</h4>
                  </div>
                  <div class="card-body">
                    <?php
                    // Tampilkan username dan nilai SUM kolom sampah_organik sesuai username
                    $query = "SELECT username, SUM(rumah) AS total FROM input GROUP BY username ORDER BY total DESC";
                    $result = mysqli_query($koneksi, $query);
                    $no = 1;
                    $data = array();
                    while ($row = mysqli_fetch_array($result)) {
               ...
               <div class="col-12 col-xl-4">
                <div class="card">
                  <div class="card-header">
                    <h4>SCOREBOARD - Jumlah Orang yang telah mengolah sampah Organik</h4>
                  </div>
                  <div class="card-body">
                    <?php
                    // Tampilkan username dan nilai SUM kolom sampah_organik sesuai nama
                    $query = "SELECT username, SUM(sampah_organik) AS total FROM input GROUP BY username ORDER BY total DESC";
                    $result = mysqli_query($koneksi, $query);
                    $no = 1;
                    while ($row = mysqli_fetch_array($result)) {
                    ?>
  ...
  <script>
    var dataForBarChart = <?php echo $grafik_data_json; ?>;

    var categories = dataForBarChart.map(item => item.x);
    var values = dataForBarChart.map(item => item.y);
