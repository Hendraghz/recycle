      ...
      <div class="container px-5">
        <div class="row gx-5 justify-content-center">
          <div class="col-xxl-12 col-12">
            <h4 class="text-center">Data Capaian Kinerja Sampah</h4>
      ...
      new Chart(ctx, {
        ...
        data: {
          labels: tableData.map(function (row) {
            return row[1]; // Kabupaten/Kota
          }),
          datasets: [{
            label: 'Timbulan Sampah Tahunan (ton/tahun)',
            data: tableData.map(function (row) {
              return parseFloat(row[2]); // Timbulan Sampah Tahunan (ton/tahun) (A)
            }),
            borderWidth: 1,
            backgroundColor: '#1509b5',
          }]
        },
        options: {
          scales: {
