          ...
          <div class="col-12 col-lg-9">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Input Data Komposisi Sampah</h4>
              </div>
                ...
                <div class="row">
                  <form action="input.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col">
                      ...
                      <div class="form-group">
                        <label for="basicInput">Sisa Makanan (%)</label>
                        <input type="number" name="makanan" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Kayu Ranting (%)</label>
                        <input type="number" name="kayu" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Kertas-Karton (%)</label>
                        <input type="number" name="kertas" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Plastik (%)</label>
                        <input type="number" name="plastik" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Logam (%)</label>
                        <input type="number" name="logam" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Kain (%)</label>
                        <input type="number" name="kain" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Karet-Kulit (%)</label>
                        <input type="number" name="karet" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Kaca (%)</label>
                        <input type="number" name="kaca" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">Lainnya (%)</label>
                        <input type="number" name="lainnya" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
