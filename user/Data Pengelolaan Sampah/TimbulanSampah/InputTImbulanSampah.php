          ...
          <div class="col-12 col-lg-9">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Input Data Timbulan Sampah</h4>
              </div>

              <div class="card-body">
                <div class="row">
                  <form action="../../input2.php" method="post" enctype="multipart/form-data">
                    <div class="col">
                    ...
                    <div class="col">
                      ...
                      <div class="form-group">
                        <label for="basicInput">Timbulan Sampah Harian</label>
                        <input type="number" name="timbulan_harian" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                      <div class="form-group">
                        <label for="basicInput">TImbulan Sampah Tahunan</label>
                        <input type="number" name="timbulan_tahunan" class="form-control" id="basicInput"
                          placeholder="Contoh : 89" />
                      </div>
                    ...
                    <div class="table-responsive">
                      <table class="table table-lg">
                        ...
                        <tbody>
                          ...
                          $previous = $halaman - 1;
                          $next = $halaman + 1;
                          $data = mysqli_query($koneksi, "select * from timbulsampah ");
                          $jumlah_data = mysqli_num_rows($data);
                          $total_halaman = ceil($jumlah_data / $batas);

                          $no = 1;
                          $data = mysqli_query($koneksi, "select * from timbulsampah WHERE username = '" . $_SESSION['username'] . "' limit $halaman_awal, $batas ");
                          while ($d = mysqli_fetch_array($data)) {
                            ...
                            <tr>
                              ...
                              <td><a href="edit-data.php?id=<?= $d['id'] ?>"><button
                                ...
                                <a href="../../hapus.php?id=<?= $d['id'] ?>"><button
